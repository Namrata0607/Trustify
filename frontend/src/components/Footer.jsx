        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <h3 className="text-xl font-bold">TRUSTIFY</h3>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed">
              Building trust through transparent ratings and authentic reviews.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/signup" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm">
                  Get Started
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/faq" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm">
                  FAQ
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm text-gray-300">
              <p className="flex items-center space-x-2">
                ...
                <span>support@trustify.com</span>
              </p>
              <p className="flex items-center space-x-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="flex items-start space-x-2">
                ...
                <span>123 Trust Street<br />Rating City, RC 12345</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-2 md:space-y-0">
            <p className="text-gray-400 text-sm">
              © 2025 Trustify. All rights reserved.
            </p>
