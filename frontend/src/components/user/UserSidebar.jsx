...
const UserSidebar = ({ activeTab, setActiveTab, isMinimized, toggleSidebar }) => {
      ...
      <div className="h-full flex flex-col justify-between">
        ...
        <div className="p-4  border-gray-100">
          ...
          <button
            ...
            className={`w-full flex items-center p-3 mb-2 rounded-lg text-gray-600 hover:bg-white/50 hover:text-gray-800 transition-colors duration-200 ${
              isMinimized ? 'justify-center' : 'justify-start space-x-3'
            }`}
